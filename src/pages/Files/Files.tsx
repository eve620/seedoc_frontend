...
export default () => {
    ...
    const onDeleteCancel = () => setIsDelete(false)
    ...
    return (
        <div className="app-container">
            ...
            <Modal okText={"确定"} cancelText={"取消"} title="新建文件夹" open={isNewDirOpen} onOk={onCreateDirOk}
            ...
            <Modal okText={"确定"} cancelText={"取消"} title="删除文件" open={isDelete} onOk={deleteObject}
